...
import com.yzsoft.yxxt.prepare.importer.StudentNoticeImportListener;
...
public class StudentNoticeImportAction extends EntityDrivenAction {
    ...
    protected Map<String, String> getPropMap() {
        ...
        map.put("学号", "code");
        map.put("姓名", "name");
        map.put("是否通知", "noticed");
        return map;
    }

    @Override
    public ItemImporterListener getImporterListener() {
        return new StudentNoticeImportListener();
    }

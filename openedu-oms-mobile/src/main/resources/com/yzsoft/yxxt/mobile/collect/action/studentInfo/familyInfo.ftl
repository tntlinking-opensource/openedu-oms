...
[@m.body title="家庭成员" back="back" rightBtnName="编辑" rightBtnUrl=b.url("!familyEdit?id=${(studentFamily.id)!}")]
<div class="yx-xxtx">
...
<form id="studentFamilyForm" action="${b.url("!familyRemove")}&id=${(studentFamily.id)!}" method="post">
</form>

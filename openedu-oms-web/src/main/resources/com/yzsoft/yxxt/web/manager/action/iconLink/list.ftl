[#ftl]
[@b.head/]
[@b.grid  items=iconLinks var="iconLink"]
    [@b.gridbar]
    ...
    [@b.row]
        ...
        [@b.col width="20%" property="img" title="图标"  align="center"]
        [#--<img src="${base}/common/download.action?uuid=${(iconLink.img)!}" style="height: 30px;"/>--]
            [#if iconLink.img??]
            <img src="${base}/${(iconLink.img)!}" style="height: 30px;"/>
            [/#if]
        [/@]

...
[@b.form name="studentSearchForm"  action="!search" target="studentlist" title="ui.searchForm" theme="search"]
    ...
    [@b.textfield label="身份证号" name="studentEnroll.student.cardcode"/]
    [@b.select label="是否通知" name="studentEnroll.noticed" items={'1':'是','0':'否'}/]
    [@b.select label="是否录取" name="studentEnroll.enrolled" items={'1':'是','0':'否'}/]
    [#--[@b.select label="招生类别" name="studentEnroll.student.enrollType.id" items=enrollTypes/]--]

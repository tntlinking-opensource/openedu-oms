...
[@b.gridbar title="菜单列表"]
	...
	bar.addItem("${b.text("action.export")}",action.exportData("code:专业方向代码,name:专业方向名称,nameEn:专业方向英文名称,grade:年级,major.code:所属专业代码,major.name:所属专业,department.code:所属院系代码,department.name:所属院系,enrollName:招生类型,num:班级人数,enabledStr:是否可用",null,"&fileName=班级信息"));

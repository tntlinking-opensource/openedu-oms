...
# 项目介绍
OPENEDU-OMS是一款校园迎新系统，涵盖通知书打印、现场迎新、信息采集、移动迎新等核心功能，显著提升迎新效率与学生体验。系统支持迎新现场实时统计，自动刷新报到进度与环节办理人数；迎新首页集成登录、新闻、流程指引等模块，学生可一站式完成信息填报、绿色通道申请、军训服装选择等操作。后台具备灵活的网站管理能力，支持信息栏目维护、采集字段自定义、通知书模板配置及生源信息管理，同时提供业务办理查询与流程配置工具。移动端集成微信服务，学生可通过手机办理登记，实现“线下+线上”一体化迎新。助力招生部门降低工作负荷，提升管理精细化水平与学生满意度。
